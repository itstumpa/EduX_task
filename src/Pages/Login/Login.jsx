 ...
 return (
  <div className="min-h-screen bg-gray-900/30 flex items-center justify-center px-4 py-20">
    <div className="flex bg-white rounded-2xl shadow-2xl max-w-[1100px] w-full overflow-hidden relative">
      ...
      {/* Image Section */}
      <div className="lg:flex justify-center items-center hidden w-1/2 bg-linear-to-br from-indigo-50 to-purple-100 p-12">
        <img
...
<div className="relative">
  ...
  />
            ...
            <button 
              type="submit" 
              className="btn w-full primary-btn text-white border-0 shadow-lg"
            >
              Login
            </button>
          ...
          <p className="text-center mt-6 text-gray-600">
            New to our website?{" "}
            <Link className="text-indigo-600 hover:text-indigo-700 font-semibold hover:underline" to="/register">
              Register
            </Link>
          </p>
        </form>
