...
const Footer = () => {
  return (
    <footer className="bg-indigo-50 pt-2 lg:pt-30 text-base-content ">
      <div className="container mx-auto py-10 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-6">
          {/* About Section */}
          <div>
            <h3 className="text-2xl font-bold text-primary mb-4">EduX</h3>
            <p className="text-sm">
              A Learning platform where you can learn, teach, and trade skills with people in your community. Join our course to get free lessons with free certificates and more.
            </p>
          </div>
